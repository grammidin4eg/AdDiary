    ...
    <table class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th class="text-field" scope="col"></th>
                <th class="text-field" scope="col"></th>
            </tr>
            <tr>
                ...
                <th scope="col">dia</th>
                <th scope="col">пульс</th>
                <th class="text-field" scope="col">Комментарий</th>
                <th class="text-field" scope="col">Лекарства</th>
            </tr>
        </thead>
        <tbody>
            <tr v-for="item in items" :key="item.id" class="table-row" @click="onItemClick(item)">
                ...
                <td class="text-field">{{ item.comment }}</td>
                <td class="text-field">{{ item.med }}</td>
            </tr>
        </tbody>
    </table>
</div>
    ...
    methods: {
        ...
        onItemClick(item) {
            ...
            if (this.$children.length) {
                this.$children[0].loadAnotherItem(item);
            }
            //debugger;
        },
